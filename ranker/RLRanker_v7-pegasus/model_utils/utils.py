...
from .generation_utils import PegasusForConditionalGeneration
from transformers import RobertaConfig, RobertaTokenizer, LongformerConfig, LongformerTokenizer, PegasusTokenizer, PegasusConfig
from transformers import PegasusConfig, PegasusTokenizer , BartTokenizer, BartConfig
...
def load_generator_model(model_args, data_args):
    generator_config = PegasusConfig.from_pretrained(
        model_args.generator_model_name_or_path,
        revision=model_args.model_revision,
        use_auth_token=True if model_args.use_auth_token else None,
    )
    generator_tokenizer = PegasusTokenizer.from_pretrained(
        model_args.generator_model_name_or_path,
        use_fast=model_args.use_fast_tokenizer,
        revision=model_args.model_revision,
        use_auth_token=True if model_args.use_auth_token else None,
    )
    generator_model = PegasusForConditionalGeneration.from_pretrained(
        model_args.generator_model_name_or_path,
