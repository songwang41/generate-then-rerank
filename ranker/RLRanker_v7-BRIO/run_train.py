...
from model_utils.utils import load_reranker_model, load_generator_model, load_generator_model_from_brio
...
class ModelArguments:
    ...
    from_BRIO: bool= field(
        default=False,
        metadata={"help": "Whether the parameters of model if from BRIO"},
    )
...
def main():
    ...
    if model_args.from_BRIO:
        generator_config, generator_tokenizer, generator_model = load_generator_model_from_brio(model_args, data_args)
    else:
