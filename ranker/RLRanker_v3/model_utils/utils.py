from .reranker_utils import RobertaRanker, LongformerRanker
...
def load_reranker_model(model_args, data_args):
    ...
    if  model_args.reranker_model_type not in ['roberta', 'longformer']:
    ...
    if data_args.reranker_max_source_length + data_args.max_target_length + 4 > reranker_config.max_position_embeddings:
        # How to understand + 4: 
        ...
        reranker_model._resize_position_embedding(data_args.reranker_max_source_length + data_args.max_target_length + 4, extend_way = model_args.position_extend_way)
        reranker_config.max_position_embeddings = data_args.reranker_max_source_length + data_args.max_target_length + 4
