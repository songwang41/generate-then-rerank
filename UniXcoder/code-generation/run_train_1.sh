...
python generate.py \
	...
	--gradient_accumulation_steps 1 \
	--num_train_epochs 30 \
    --save_dir predictions/train/gen_from_16_diverse \
    --do_sample
...
python generate.py \
	...
	--gradient_accumulation_steps 1 \
	--num_train_epochs 30 \
    --save_dir predictions/dev/gen_from_16_diverse
...
python generate.py \
	...
	--gradient_accumulation_steps 1 \
	--num_train_epochs 30 \
    --save_dir predictions/test/gen_from_16_diverse
