...
class ModelArguments:
    ...
    generator_checkpoint_dir: Optional[str] = field(
        default=None,
        metadata={"help": "The warmuped checkpoint for generator"},
    )
...
def main():
    ...
    generator_config, generator_tokenizer, generator_model = load_generator_model(model_args)
